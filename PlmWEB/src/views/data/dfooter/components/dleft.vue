    ...
    <div style="display: inline-block; width: 100%">
      <div class="user_skills">
        <el-table :data="tableData" class="top"  cell-style="font-weight: 700;color:#fff" :header-cell-style="{background:'#19d2d8',color:'#000000'}">
          ...
          <el-table-column align="center" prop="shenyutianshu" label="剩余天数" width="100px" ></el-table-column>
          <el-table-column align="center" prop="jindu" label="完成比例" width="120px" ></el-table-column>
        </el-table>
...
<script>
import {youxiaNo} from '@/api/plmApi'
export default {
  components: {
