<template>
  <div class="user_skills">
    ...
    <div class="partcomwithborder border" style="margin-top:10px">
      <el-table :data="jinliData" style="width: 100%"  cell-style="font-weight: 700;color:#fff" :header-cell-style="{background:'#19d2d8',color:'#000000'}">
        <el-table-column align="center" prop="xiangmujinli" label="项目经理"></el-table-column>
        <el-table-column align="center" prop="paiming" label="排名"> </el-table-column>
      </el-table>
    </div>
     <!-- <div class="partcomwithborder border" style="margin-top:10px">
...
import {zhongbiao,PojSumFType,youxiaTwo,youshangTwoFTypeTop} from '@/api/plmApi'
...
computed: {
  ...
  methods: {
    ...
    youshangTwoFTypeTop(){
      youshangTwoFTypeTop().then(
        (response) => {
          this.jinliData = response.data;
        }
      ).catch(e => {
